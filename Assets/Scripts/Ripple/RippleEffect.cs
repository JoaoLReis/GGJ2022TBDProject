...
public class RippleEffect : MonoBehaviour
{
    ...
    [Range(0.01f, 1.0f)]
    public float reflectionStrength = 0.2f;
    ...
    {
        ApplyGravityFromPlanets.ChangePolarity += Trigger;
    }
    ...
    private void Trigger(bool _)
    {
        ...
        var target = player ? player.transform : transform;
        Emit(Camera.main.WorldToViewportPoint(target.position));
    }
